(function () {
  try {
    var debug = 0;
    var variation_name = "cre-t-133-v2";
    ...
    function init() {
      if (getCookie("cre-t-133-v2-seen")) { track("100037881"); return; }
      ...
      setTimeout(function () {
        ...
        /* cookie set immediately on inject — no reload or new-tab repeat */
        setCookie("cre-t-133-v2-seen", "1");
