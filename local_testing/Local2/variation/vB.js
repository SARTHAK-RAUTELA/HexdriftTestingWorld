(function () {
    try {
        /* Main variables */
        var debug = 0;
        var variation_name = "FieldPulse"; // Variation name for tracking
 ...
 <section class="thumbtack-section thumbtack-section-variation">
  ...
  <div class="testimonials">
    ...
    <div class="testimonial-cards">
      <div class="card">
        <img src="https://cdn.optimizely.com/img/20611073899/f524c7f63d37407c93087f9896de1942.png " alt="Alex">
        
        <p>“About 80–85% of our leads come from the platform. It’s helped us grow quickly, keep our schedule full, and build real relationships with customers that often turn into repeat work.”</p>
        <span>— Jack M., Electric AVenue</span>
      </div>
      <div class="card">
       <img src="https://cdn.optimizely.com/img/20611073899/6ca18004268b489ab920251e75c49591.png" alt="Beth">
      
      <p>“By focusing on fast response times and delivering great service, we’ve been able to turn [Thumbtack] leads into long-term customers.”</p>
        <span>— Clay R., Mr Electric of Golden, CO</span>
      </div>
      <div class="card">
        <img src="https://cdn.optimizely.com/img/20611073899/3f6cc2b836fd4dd0a125ca4113e99b4f.png" alt="Mehdi">
        <p>“Thumbtack has helped us
connect with homeowners looking for reliable, all-in-one solutions. That alignment has allowed us to maintain a consistent pipeline
while continuing to grow.”</p>
        <span>— Deon M., Antilleon Restoration</span>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="feature-row">
        ...
        <div class="feature-item">
          <img src="https://cdn.optimizely.com/img/20611073899/601e24ba9fa14b03a789889e87a4dddd.png" alt="Painting by Kay">
        ...
        <!-- Feature 2 -->
        <div class="feature-item">
          <img src="https://cdn.optimizely.com/img/20611073899/37eee94d85cf49cfa77f5eff3fdac648.png" alt="Steve B. chat">
        ...
        <!-- Feature 3 -->
        <div class="feature-item">
          <img src="https://cdn.optimizely.com/img/20611073899/aa6fc231c29b42d988d81df80e58b3bc.png" alt="Insights dashboard">
...
;
        ...
        function init() {
          ...
          document.title = "FieldPulse-Thumbtack";
          ...
          if (target && !alreadyExists) {
              target.insertAdjacentHTML('beforebegin', `
                  <div class="section_topimage">
                      <img class="desktop_image" src="https://cdn.optimizely.com/img/20611073899/fdc28cfc83634964918b861e2b4cb3f1.png">
                      <img class="mobile_image" src="https://cdn.optimizely.com/img/20611073899/fdc28cfc83634964918b861e2b4cb3f1.png">
                  </div>
              `);
          }
...
waitForElement(
  ...
  function() {
    ...
    if (el) {
      el.innerHTML = 'In partnership with FieldPulse. <a href="https://www.thumbtack.com/sales?utm_source=partner&utm_medium=partnerships&utm_campaign=fieldpulse">Book a call with our team.</a>';
    }
  },
  100,
  15000
...
document.querySelector('[class*="hero_heroTitle"] + p').innerText = 'Receive $100 in free leads when you set up your Thumbtack profile as a FieldPulse pro.*';
}, 100, 15000);
