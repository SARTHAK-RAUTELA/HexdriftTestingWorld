(function () {
  try {
    ...
    /* -----------------------------------------------------------------
       ...
       ----------------------------------------------------------------- */
    function fireVwoGoal(eventName) {
    ...
    /* Client-specified goal: "AFP21 - Clicks on any tooltip". Fires on
       every click of a value-table tooltip icon, desktop or mobile. */
    var CLICKS_ON_ANY_TOOLTIP_GOAL = "apf21ClicksOnAnyTooltip";
    ...
    var testimonialsData = [
      {
        img: "https://v2.crocdn.com/AFP/test21/img16.jpg",
      ...
      {
        img: "https://v2.crocdn.com/AFP/test21/img13.jpg",
      ...
      {
        img: "https://v2.crocdn.com/AFP/test21/img3.jpg",
      ...
      {
        img: "https://v2.crocdn.com/AFP/test21/img15.jpg",
  ...
  <path d="M25.0423 23.9578C24.6038 23.5192 24.3845 22.9885 24.3845 22.3655C24.3845 21.7423 24.6038 21.2115 25.0423 20.773C25.4808 20.3347 26.0115 20.1155 26.6345 20.1155C27.2577 20.1155 27.7884 20.3347 28.2268 20.773C28.6653 21.2115 28.8845 21.7423 28.8845 22.3655C28.8845 22.9885 28.6653 23.5192 28.2268 23.9578C27.7884 24.3962 27.2577 24.6155 26.6345 24.6155C26.0115 24.6155 25.4808 24.3962 25.0423 23.9578ZM21.8845 29.6155V28.4655C21.8845 28.1103 21.9753 27.7843 22.157 27.4873C22.3387 27.1903 22.5966 26.9766 22.9307 26.8463C23.5124 26.6026 24.1143 26.4198 24.7363 26.298C25.3583 26.1763 25.991 26.1155 26.6345 26.1155C27.2652 26.1155 27.8918 26.1763 28.5142 26.298C29.1368 26.4198 29.7448 26.6026 30.3385 26.8463C30.6727 26.9766 30.9305 27.1903 31.112 27.4873C31.2937 27.7843 31.3845 28.1103 31.3845 28.4655V29.6155H21.8845ZM17.026 20.974C16.342 20.2902 16 19.4655 16 18.5C16 17.5347 16.342 16.71 17.026 16.026C17.7098 15.342 18.5345 15 19.5 15C20.4653 15 21.29 15.342 21.974 16.026C22.658 16.71 23 17.5347 23 18.5C23 19.4655 22.658 20.2902 21.974 20.974C21.29 21.658 20.4653 22 19.5 22C18.5345 22 17.7098 21.658 17.026 20.974ZM12 29.6155V27.3923C12 26.8927 12.1304 26.4336 12.3913 26.0148C12.6523 25.5959 13.0102 25.2808 13.4653 25.0693C14.4076 24.5949 15.3857 24.234 16.3995 23.9865C17.4133 23.7392 18.4468 23.6155 19.5 23.6155C19.9935 23.6155 20.4871 23.6511 20.9808 23.7222C21.4743 23.7934 21.9678 23.8796 22.4615 23.9808C22.2487 24.1968 22.0358 24.4128 21.823 24.629L21.1845 25.277C20.9038 25.2097 20.6231 25.1659 20.3422 25.1458C20.0614 25.1256 19.7807 25.1155 19.5 25.1155C18.5653 25.1155 17.6467 25.2225 16.7442 25.4365C15.8416 25.6507 14.9781 25.9744 14.1538 26.4078C13.9614 26.5103 13.8043 26.6445 13.6825 26.8105C13.5608 26.9767 13.5 27.1706 13.5 27.3923V28.1155H19.5V29.6155H12ZM20.9125 19.9125C21.3042 19.5208 21.5 19.05 21.5 18.5C21.5 17.95 21.3042 17.4792 20.9125 17.0875C20.5208 16.6958 20.05 16.5 19.5 16.5C18.95 16.5 18.4792 16.6958 18.0875 17.0875C17.6958 17.4792 17.5 17.95 17.5 18.5C17.5 19.05 17.6958 19.5208 18.0875 19.9125C18.4792 20.3042 18.95 20.5 19.5 20.5C20.05 20.5 20.5208 20.3042 20.9125 19.9125Z" fill="white"></path>
    ...
    /* -----------------------------------------------------------------
       Tooltip copy for the value-table "Benefit" column.
       Keyed to each valueTableData item via the `tooltip` field below.
       ----------------------------------------------------------------- */
    var valueTableData = [
      {
        group: "Learn &amp; Develop",
        items: [
          {
            benefit: "AFP Learn Interactive Platform",
            nonMember: "Not Available",
            member: "Included",
            tooltip:
              "Access 100+ live and on-demand learning opportunities across treasury, FP&amp;A and payments, and build a personalized learning library around the skills you want to develop.",
          },
          {
            benefit: "Live Webinars (24+ per year)",
            nonMember: "$50 per webinar",
            member: "Included",
            tooltip:
              "Stay current on timely treasury, finance and payments topics through expert-led live sessions, with opportunities to earn CTP, FPAC and CPE credits.",
          },
          {
            benefit: "Live Virtual Workshops (4+ per year)",
            nonMember: "$295 per workshop",
            member: "Included",
            tooltip:
              "Go deeper into key treasury and finance topics through interactive, instructor-led workshops, with opportunities to earn CTP, FPAC and CPE credits.",
          },
          {
            benefit: "On-Demand Webinars &amp; Courses",
            nonMember: "Not Available",
            member: "Included",
            tooltip:
              "Learn on your schedule with on-demand webinars, courses and recorded sessions covering foundational skills, best practices and emerging industry topics.",
          },
          {
            benefit: "Digital Badges",
            nonMember: "$50 per badge",
            member: "Included",
            tooltip:
              "Build expertise in focused treasury and finance topics and earn verifiable digital credentials you can share on your resume and professional profiles.",
          },
        ],
      },
      {
        ...
        items: [
          {
            benefit: "AFP Collaborate Community",
            nonMember: "Not Available",
            member: "Included",
            tooltip:
              "Ask questions, exchange ideas and get practical answers from treasury and finance peers in AFP&rsquo;s exclusive online community.",
          },
          {
            benefit: "Virtual Member Meet-Ups (6+ per year)",
            nonMember: "$50 per meet-up",
            member: "Included",
            tooltip:
              "Join live peer discussions on relevant challenges and hear how other treasury and finance professionals are approaching them in real time.",
          },
          {
            benefit: "Member Networking Opportunities",
            nonMember: "Limited Access",
            member: "Included",
            tooltip:
              "Build relationships with treasury and finance peers through AFP events, communities and programs, creating connections you can draw on throughout your career.",
          },
        ],
      },
      {
        ...
        items: [
          {
            benefit: "Research Reports",
            nonMember: "$295 per report",
            member: "Included",
            tooltip:
              "Access data-backed, original AFP research on topics such as payments fraud, benchmarking and compensation to inform decisions and understand industry trends.",
          },
          {
            benefit: "Tools &amp; Templates",
            nonMember: "Not Available",
            member: "Included",
            tooltip:
              "Work smarter and faster with ready-to-use templates, dashboards, scorecards and other practical resources you can customize for your organization.",
          },
          {
            benefit: "Industry Benchmarking Resources",
            nonMember: "Limited Access",
            member: "Included",
            tooltip:
              "Compare your organization&rsquo;s practices and performance with peer data to identify gaps, validate decisions and understand where you stand.",
          },
          {
            benefit: "Practical Guides &amp; Checklists",
            nonMember: "Limited Access",
            member: "Included",
            tooltip:
              "Turn treasury and finance concepts into action with practitioner-informed guides, checklists and practical guidance you can apply at work.",
          },
        ],
      },
      {
        ...
        items: [
          {
            benefit: "Member Pricing for AFP Events",
            nonMember: "Standard Pricing",
            member: "Discounted",
            tooltip:
              "Save with exclusive member pricing on AFP conferences and events while accessing education, practitioner insights and peer networking.",
          },
          {
            benefit: "Member Pricing for Certification",
            nonMember: "Standard Pricing",
            member: "Discounted",
            tooltip:
              "Save with exclusive member pricing on AFP certification products and resources for the CTP&reg; and FPAC&reg; credentials.",
          },
          {
            benefit: "Certification Credit Opportunities",
            nonMember: "Pay Per Activity",
            member: "Included",
            tooltip:
              "Earn eligible CTP and FPAC continuing education credits through AFP membership, webinars, workshops, courses and other member benefits, often at no additional cost.",
          },
          {
            benefit: "Professional Development Resources",
            nonMember: "Limited Access",
            member: "Included",
            tooltip:
              "Keep developing your skills and career with AFP learning, practical resources, industry insights and professional development opportunities.",
          },
        ],
      },
    ];
    ...
    function checkIconSVG(color) {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="17" height="13" viewBox="0 0 17 13" fill="none"><path d="M5.7 12.025L0 6.325L1.425 4.9L5.7 9.175L14.875 0L16.3 1.425L5.7 12.025Z" fill="${color}"></path></svg>`;
    }

    /* Help/question-mark icon used next to a Benefit label to open its tooltip. */
    function tooltipIconSVG() {
      return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M11,18H13V16H11V18M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20M12,6A4,4 0 0,0 8,10H10A2,2 0 0,1 12,8A2,2 0 0,1 14,10C14,12 11,11.75 11,15H13C13,12.75 16,12.5 16,10A4,4 0 0,0 12,6Z"></path></svg>`;
    }
    ...
    function buildTestimonialsHTML() {
      return testimonialsData
        .map(function (t) {
          return `<div class="swiper-slide"><article class="testimonial-card"><div class="placeholder-box testimonial-card__photo" aria-hidden="true"><img src="${t.img}" alt="" loading="lazy"></div><div class="testimonial-card__body"><p class="testimonial-card__quote">&ldquo;${t.quote}&rdquo;</p><p class="testimonial-card__author">${t.name}<br><span>${t.role}</span></p></div></article></div>`;
        })
        .join("");
    }
    ...
    function buildFeaturesHTML() {
      return featuresData
        .map(function (f) {
          return `<div class="feature-card"><div class="feature-card__icon" aria-hidden="true">${f.svg}</div><h3>${f.title}</h3><p>${f.desc}</p></div>`;
        })
        .join("");
    }
    ...
    function buildContentBlocksHTML() {
      return contentBlocksData
        .map(function (b) {
          return `<section class="content-block${b.reverse ? " content-block--reverse" : ""}">
    ...
    function buildValueTableHTML() {
      ...
      valueTableData.forEach(function (group) {
        ...
        group.items.forEach(function (item) {
          var tooltipMarkup = item.tooltip
            ? `<span class="tooltip-wrap"><button type="button" class="tooltip-icon" aria-label="More info about ${item.benefit}" aria-expanded="false">${tooltipIconSVG()}</button><span class="tooltip-box" role="tooltip">${item.tooltip}</span></span>`
            : "";
          rows += `<tr><td data-label="Benefit"><span class="benefit-cell"><span class="benefit-text">${item.benefit}</span>${tooltipMarkup}</span></td><td data-label="AFP Non-Member">${item.nonMember}</td><td data-label="AFP Member" class="is-included"><span class="check">${checkIconSVG("#0076A8")}</span> ${item.member}</td></tr>`;
        });
      });
      return rows;
    }
...
<div class="value-table__cta"><a href="#join" class="btn btn--primary">JOIN AFP</a></div>
    ...
    <div class=" start-membership__grid">
        ...
        <div class="start-membership__price">
            ...
            <p class="price__sub">Individual Membership · 12 months from the month you join</p>

            <p class="price__desc">Join more than 10,000 treasury and finance professionals who use AFP to make better decisions, stay current and advance their careers.</p>` + `

            <a href="https://eweb.afponline.org/eweb/DynamicPage.aspx?WebCode=LoginRequired&expires=yes&Site=afp" id="start-membership-join-btn" class="btn btn--primary">JOIN AFP</a>

            <p class="start-membership__note"><span class="check">${checkIconSVG("#027DB6")}</span>Immediate access to your member benefits</p>
        ...
        <div class="start-membership__options">
            ...
            <div class="option">
                <h3><span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
...
</svg></span>Pay over time with Affirm</h3>
                <p>Eligible U.S. members can choose Affirm at checkout.</p>
            </div>

            <div class="option Cre_hide">
                <h3><span><svg xmlns="http://www.w3.org/2000/svg" width="26" height="21" viewBox="0 0 26 21" fill="none">
...
</svg></span>Student &amp; Early Career Membership</h3>
                <p>Reduced pricing for students and early-career professionals.</p>
            </div>
...
</svg></span>Corporate Membership</h3>
                <p>Membership for organizations and teams. Contact <a href="mailto:corporatemembership@financialprofessionals.org">corporatemembership@financialprofessionals.org</a> to check if your organization is already a Corporate Member. <a href="https://www.financialprofessionals.org/membership/explore-membership/afp-corporate-membership">Explore Corporate Membership →</a></p>
            </div>

        </div>

    </div>
    <div class="Cre_explore-membership_redesing__footer-text">
        <p><span>Questions before joining?</span> Email <a href="mailto:customerservice@financialprofessionals.org">customerservice@financialprofessionals.org</a> </p>
    </div>
</section>` +
...
<a href="#join" class="btn btn--primary">JOIN AFP</a>
    ...
    function initSwiper() {
      ...
      /* -----------------------------------------------------------------
         GOAL: "AFP21 - Scroll testimonials" (V1 only)
         ----------------------------------------------------------------- */
      function fireScrollTestimonialsGoal() {
        fireVwoGoal("scrollTestimonials");
      }

      // 1) pagination bullet clicks — bullets are injected by Swiper at
      //    runtime, so bind through live() (document-level delegation)
      //    instead of grabbing the container and attaching directly to it.
      live(".testimonials .swiper-pagination .swiper-pagination-bullet", "click", function (e) {
        fireScrollTestimonialsGoal();
      });

      // 2) prev/next arrow clicks
      live(".testimonials-nav__prev", "click", fireScrollTestimonialsGoal);
      live(".testimonials-nav__next", "click", fireScrollTestimonialsGoal);

      // 3) drag / swipe on the slider track (mouse-drag works too because
      //    grabCursor: true enables Swiper's simulated touch events)
      swiperInstance.on("touchEnd", function (swiper) {
        if (swiper.touches && Math.abs(swiper.touches.diff) > 0) {
          fireScrollTestimonialsGoal();
        }
      });
    }
    ...
    function wireStartMembershipJoinButton(controlAnchor) {
      live("#start-membership-join-btn", "click", function (e) {
    ...
    function positionTooltipBox(wrapEl) {
      var icon = wrapEl.querySelector(".tooltip-icon");
      var box = wrapEl.querySelector(".tooltip-box");
      if (!icon || !box) return;

      var margin = 12;
      var gap = 10; // space between the icon and the box
      var iconRect = icon.getBoundingClientRect();
      var boxWidth = box.offsetWidth || 260;
      var boxHeight = box.offsetHeight || 60;
      var viewportWidth = document.documentElement.clientWidth || window.innerWidth;
      var viewportHeight = document.documentElement.clientHeight || window.innerHeight;

   
      var left = iconRect.left;
      var maxLeft = viewportWidth - boxWidth - margin;
      if (left > maxLeft) left = maxLeft;
      if (left < margin) left = margin;

      // Vertical: prefer above the icon; flip below it if there isn't
      // room above (e.g. the row is near the top of the screen).
      var top = iconRect.top - boxHeight - gap;
      var below = false;
      if (top < margin) {
        top = iconRect.bottom + gap;
        below = true;
      }
      // If flipping below would also run off the bottom, just clamp
      // it on-screen rather than letting it overflow either edge.
      if (below && top + boxHeight > viewportHeight - margin) {
      ...
      // Point the arrow at the icon's horizontal center, clamped so it
      // never renders outside the box itself.
      var arrowLeft = iconRect.left + iconRect.width / 2 - left;
      arrowLeft = Math.max(12, Math.min(boxWidth - 12, arrowLeft));
    ...
    function initValueTableTooltips(scopeEl) {
      ...
      /* Device-level fallback for whether this is a real hover-capable
         pointer (desktop mouse) vs. touch/pen — used to decide whether a
         hover should also count as tooltip engagement for the AFP21
         goal below, since desktop users never click (only hover) and
         would otherwise never trigger it. */
      var isHoverCapableDevice = !!(
        window.matchMedia && window.matchMedia("(hover: hover)").matches
      );

      function closeAllTooltips(exceptWrapEl) {
        var openWraps = scopeEl.querySelectorAll(".tooltip-wrap.is-open");
        for (var i = 0; i < openWraps.length; i++) {
          if (openWraps[i] !== exceptWrapEl) {
            openWraps[i].classList.remove("is-open");
            var btn = openWraps[i].querySelector(".tooltip-icon");
      ...
      live(
        ...
        function (e) {
          ...
          activeHoverWrap = this;
          positionTooltipBox(this);

          /* AFP21 goal: desktop users only ever hover (never click) to
             see a tooltip, so hover has to count as engagement here too
             — otherwise the goal would never fire on desktop. Gated to
             real hover-capable devices so a touch tap's synthetic
      ...
      live(
        ...
        function (e) {
          if (this.contains(e.relatedTarget)) return;
          if (activeHoverWrap === this) activeHoverWrap = null;
        },
        scopeEl
      );

        // goal, since that's tracking mouse-hover + click only.
      live(
        ".tooltip-wrap",
        "focusin",
        function () {
      ...
      // Desktop (mouse) should rely purely on the CSS :hover/:focus-within
      // rules above; toggling "is-open" on click there left it stuck open,
      // so hovering a different row's tooltip showed both at once (BUG).
      // Touch/pen taps have no real hover, so they still need the
      // click-to-toggle behavior below.
      //
      // matchMedia("(hover: hover)") (isHoverCapableDevice, declared above)
      // is a static, device-level fallback — it can misreport a "mobile"
      // test that's actually a narrowed desktop browser window still
      // driven by a real mouse (mouse input still reports hover:hover =
      // true there). Pointer Events give the actual input type of the
      // interaction that's happening right now, so prefer that: record
      // it on pointerdown and use it in the click handler below, falling
      // back to the device check only if the browser has no Pointer
      // Events support at all.
      ...
      // Chrome (and other Chromium browsers) focuses a <button> on mouse
      // click by default. Our :focus-within CSS shows the tooltip for
      // real keyboard/Tab users, but that same rule was also pinning the
      // tooltip open on a plain desktop mouse click, since the click
      // gave the button focus. preventDefault on mousedown blocks that
      // mouse-driven focus without affecting keyboard Tab focus (Tab
      // doesn't fire mousedown) or the click event itself.
      live(
        ".tooltip-icon",
        "mousedown",
        function (e) {
          var isMouseInput = lastPointerType
            ? lastPointerType === "mouse"
            : isHoverCapableDevice;
          if (isMouseInput) e.preventDefault();
        },
        scopeEl
      );

      // Touch/click: tap the icon to open, tap again (or elsewhere) to
      // close.
      live(
        ".tooltip-icon",
        "click",
        function (e) {
          ...
          var wrapEl = this.parentElement;
          if (!wrapEl) return;
          var wasOpen = wrapEl.classList.contains("is-open");
          closeAllTooltips(wrapEl);
          if (wasOpen) {
      ...
      // Close any open tooltip when tapping/clicking outside of it.
      document.addEventListener("click", function (e) {
        var el = e.target;
        while (el && el !== document) {
          if (el.classList && el.classList.contains("tooltip-wrap")) return;
          el = el.parentNode;
        }
        closeAllTooltips(null);
      });

      // Keep an open/hovered tooltip correctly positioned as the page
      // scrolls or the viewport resizes, instead of letting it drift
      ...
      window.addEventListener("resize", debounce(repositionVisibleTooltips, 100));
    }
    ...
    function init() {
      ...
      initValueTableTooltips(mountEl);
