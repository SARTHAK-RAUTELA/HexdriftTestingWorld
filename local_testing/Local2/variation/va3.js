(function () {
  try {
    ...
    var partnerRatingData = [
      { dataLabel: "outbound-partner-clicks-Embrace-Listing-Only", total: "9.6", classification: "Exceptional", popularity: "8.4", valueForMoney: "8.7", reviews: "8.3", popularityPercentage: "84%", valueForMoneyPercentage: "87%", reviewsPercentage: "83%" },
    ...
    /* ===== container / card identification -- ALL NEW ===== */
